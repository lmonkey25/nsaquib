...
angular.module('users').config(['$stateProvider',
	function($stateProvider) {
		...
		state('profile', {
			...
			templateUrl: 'modules/users/views/settings/edit-profile-gen.client.view.html'
		}).
		state('links', {
			url:'/settings/profile/links',
			templateUrl: 'modules/users/views/settings/links-profile.client.view.html'
		}).
		state('password', {
